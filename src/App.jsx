...
function CatalogPage({ onOpenRegister, onOpenLogin, onOpenCliente }) {
  ...
  return (
    <main className={`main ${isSearching ? 'main--searching' : ''}`}>
      {!user && (
        <section className="auth-row" aria-label="Acesso da conta">
          <div className="auth-row-inner">
            <button type="button" className="auth-row-btn auth-row-btn--login" onClick={onOpenLogin}>
              <svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2.4" strokeLinecap="round" strokeLinejoin="round" aria-hidden="true">
                <path d="M15 3h4a2 2 0 0 1 2 2v14a2 2 0 0 1-2 2h-4"/><polyline points="10 17 15 12 10 7"/><line x1="15" y1="12" x2="3" y2="12"/>
              </svg>
              <span>Entrar</span>
            </button>
            <button type="button" className="auth-row-btn auth-row-btn--register" onClick={onOpenRegister}>
              <svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2.4" strokeLinecap="round" strokeLinejoin="round" aria-hidden="true">
                <path d="M16 21v-2a4 4 0 0 0-4-4H6a4 4 0 0 0-4 4v2"/><circle cx="9" cy="7" r="4"/><line x1="19" y1="8" x2="19" y2="14"/><line x1="22" y1="11" x2="16" y2="11"/>
              </svg>
              <span>Quero me cadastrar</span>
            </button>
            <button type="button" className="auth-row-btn auth-row-btn--cliente" onClick={onOpenCliente}>
              <svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2.4" strokeLinecap="round" strokeLinejoin="round" aria-hidden="true">
                <path d="M20 21v-2a4 4 0 0 0-4-4H8a4 4 0 0 0-4 4v2"/><circle cx="12" cy="7" r="4"/>
              </svg>
              <span>Já sou cliente antigo</span>
            </button>
          </div>
        </section>
      )}
