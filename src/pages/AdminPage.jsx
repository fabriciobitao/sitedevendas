  ...
  return (
    <div className="admin-page">
      ...
      <div className="admin-fab" role="toolbar" aria-label="Acoes do gerenciador">
        <button
          className="admin-fab-btn admin-fab-pdf-out"
          onClick={() => navigate('/admin/catalogo?tipo=esgotados')}
          title="PDF de produtos esgotados"
          aria-label="PDF de produtos esgotados"
        >
          <svg width="22" height="22" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
            <circle cx="12" cy="12" r="10" /><line x1="4.93" y1="4.93" x2="19.07" y2="19.07" />
          </svg>
          <span className="admin-fab-label">Esgotados</span>
        </button>
        <button
          className="admin-fab-btn admin-fab-pdf"
          onClick={() => navigate('/admin/catalogo?tipo=estoque')}
          title="PDF do catalogo"
          aria-label="PDF do catalogo"
        >
          <svg width="22" height="22" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
          ...
          <span className="admin-fab-label">Catálogo</span>
        </button>
        <button
